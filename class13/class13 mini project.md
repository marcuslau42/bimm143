...
![](class13-mini-project_files/figure-gfm/unnamed-chunk-12-1.png)
...
![](class13-mini-project_files/figure-gfm/unnamed-chunk-13-1.png)
...
Save my results so far to a CSV file \>Q. Finally for this section let’s
reorder these results by adjusted p-value and save them to a CSV file in
...
Again we will use the ‘gage()’ package and functino with a focus first
on KEGG and sigment
...
```
    ...
    Info: Working in directory /Users/marcuslau/Desktop/BIMM143/bimm143/class13
...
The pathway with the most significant p-value is Endosomal/Vacuolar
pathway. P value was 1.67E-4. Some of the most significant pathways do
match our previous KEGG results. Factors that caused these differences
include different data bases.
